...
export const RAW_GOODS_STATE_NAME = 'raw-goods';

export const RAW_GOODS_CONTENT_STATE_NAME = 'content';
export const RAW_GOODS_FORM_STATE_NAME = 'form';

const state = createFeatureSelector<RawGoodsState>(RAW_GOODS_STATE_NAME);
